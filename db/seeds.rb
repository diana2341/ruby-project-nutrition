user1=User.create(name:"diana",age:20,weight:120,password:"1234")
user2=User.create(name:"sam",age:30,weight:130,password:"123456")
user3=User.create(name:"maria",age:40,weight:140,password:"12345")
